package com.esp;
  ...
  public class EspRenderer {
      ...
      public static void onRenderLevel(RenderLevelStageEvent event) {
          ...
          // PoseStack: только T(-camPos). Шейдер (ModelViewMat) сам применяет view rotation.
          ...
          // ── Проход 1: угловые скобки + HP-бар ─────────────────────────────
          for (Player player : players) {
              ...
              // Верх = конфиг-цвет, низ = темнее (градиент)
      ...
      // ── Corner-bracket бокс (8 углов × 3 ребра, верх светлее, низ темнее) ─
      private static void renderCornerBox(PoseStack ps, VertexConsumer buf,
          ...
          // Нижние 4 угла (тёмный)
          seg(ps, buf, mx1, my1, mz1, mx1+lx, my1, mz1, rd,gd,bd);
          seg(ps, buf, mx1, my1, mz1, mx1, my1, mz1+lz, rd,gd,bd);
          seg(ps, buf, mx1, my1, mz1, mx1, my1+ly, mz1, rd,gd,bd);

          seg(ps, buf, mx2, my1, mz1, mx2-lx, my1, mz1, rd,gd,bd);
          seg(ps, buf, mx2, my1, mz1, mx2, my1, mz1+lz, rd,gd,bd);
          seg(ps, buf, mx2, my1, mz1, mx2, my1+ly, mz1, rd,gd,bd);

          seg(ps, buf, mx1, my1, mz2, mx1+lx, my1, mz2, rd,gd,bd);
          seg(ps, buf, mx1, my1, mz2, mx1, my1, mz2-lz, rd,gd,bd);
          seg(ps, buf, mx1, my1, mz2, mx1, my1+ly, mz2, rd,gd,bd);

          seg(ps, buf, mx2, my1, mz2, mx2-lx, my1, mz2, rd,gd,bd);
          seg(ps, buf, mx2, my1, mz2, mx2, my1, mz2-lz, rd,gd,bd);
          seg(ps, buf, mx2, my1, mz2, mx2, my1+ly, mz2, rd,gd,bd);

          // Верхние 4 угла (светлый)
          seg(ps, buf, mx1, my2, mz1, mx1+lx, my2, mz1, r,g,b);
          seg(ps, buf, mx1, my2, mz1, mx1, my2, mz1+lz, r,g,b);
          seg(ps, buf, mx1, my2, mz1, mx1, my2-ly, mz1, r,g,b);

          seg(ps, buf, mx2, my2, mz1, mx2-lx, my2, mz1, r,g,b);
          seg(ps, buf, mx2, my2, mz1, mx2, my2, mz1+lz, r,g,b);
          seg(ps, buf, mx2, my2, mz1, mx2, my2-ly, mz1, r,g,b);

          seg(ps, buf, mx1, my2, mz2, mx1+lx, my2, mz2, r,g,b);
          seg(ps, buf, mx1, my2, mz2, mx1, my2, mz2-lz, r,g,b);
          seg(ps, buf, mx1, my2, mz2, mx1, my2-ly, mz2, r,g,b);

          seg(ps, buf, mx2, my2, mz2, mx2-lx, my2, mz2, r,g,b);
          seg(ps, buf, mx2, my2, mz2, mx2, my2, mz2-lz, r,g,b);
          seg(ps, buf, mx2, my2, mz2, mx2, my2-ly, mz2, r,g,b);
      }
      ...
      private static void addLine(PoseStack ps, VertexConsumer buf,
          ...
          buf.addVertex(mat, (float)x1,(float)y1,(float)z1).setColor(r,g,b,a).setNormal(norm,dx,dy,dz);
          buf.addVertex(mat, (float)x2,(float)y2,(float)z2).setColor(r,g,b,a).setNormal(norm,dx,dy,dz);
      }
  }
